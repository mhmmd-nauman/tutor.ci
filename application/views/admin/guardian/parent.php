			...
			<div class="col-md-4">
				<div class="w50percent">
					<div class="wh90percent textleft">
						<span class="opensans size13"><b>Gardian Name</b></span>
			...
			<div class="col-md-4">
				<div class="padding20">
					<button class="btn-search4 margleft15" type="submit">Search</button>&nbsp;&nbsp;
                                        <a href="" class="glyphicon glyphicon-floppy-save" data-toggle="modal" data-target="#parent_add">Insert Guardian</a>
				</div>
			</div>
	...
	<div class="table-responsive">
		<table class="table-striped">
			...
			<tr>
                            ...
                            <td>
                                <a href="" class="glyphicon glyphicon-search modalLink" data-toggle="modal" data-target="#parent_view<?php echo $id;?>">Preview</a> 
                                <a href="" class="glyphicon glyphicon-search modalLink" data-toggle="modal" data-target="#parent_edit<?php echo $id;?>">Edit</a>
                                <a href="" class="glyphicon glyphicon-remove-sign" data-toggle="modal" data-target="#parent_delete<?php echo $id;?>">Delete</a>
                            </td>
                        </tr>
                        <?php } ?>
		</table>
...
<?php
        ...
        {   
            ...
            $email=$row->email;
?>
<div class="modal fade" id="parent_edit<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<?php
        ...
        { 
            $id=$row->user_id;
?>
<div class="modal fade" id="parent_delete<?php echo $id;?>"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
...
<script>
            $(function() {
                <?php
                    if ($this->session->userdata('g_sess_add_record_type') == 'error') { ?>
                    //$('#stu_add').modal('show');
                    });
                    <?php } ?>
</script>

<div class="modal fade" id="parent_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
                                    <?php
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <div class="alert alert-danger">
                                                      <strong><?php echo $this->session->userdata('g_sess_add_record_msg');?></strong> 
                                                </div>
                                            <?php }?>
                                        <div class="avatar"> <img src="<?php echo base_url(); ?>images/dash/avatar.jpg"/> </div>
					<div class="form-group">
                                            ...
                                            <div class="form-group col-md-3">
                                                <?php 
                                                    $firstname=$this->session->userdata('g_first_name');
                                                    $lastname=$this->session->userdata('g_last_name');
                                                    $mail=$this->session->userdata('g_email');
                                                ?>
