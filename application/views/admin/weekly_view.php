...
<head>
  ...
  <script type='text/javascript' src='<?php echo base_url();?>assets/calendar_file/libs/jquery-1.4.4.min.js'></script>
  <script type='text/javascript' src='<?php echo base_url();?>assets/calendar_file/libs/jquery-ui-1.8.11.custom.min.js'></script>
