	...
	<div class="footerbgblack">
		<div class="container">		
			...
			<div class="col-md-3">
				...
				<div class="scont">
					<a href="#" class="social1b"><img src="<?php echo base_url(); ?>images/icon-facebook.png" alt=""/></a>
					<a href="#" class="social2b"><img src="<?php echo base_url(); ?>images/icon-twitter.png" alt=""/></a>
					<a href="#" class="social3b"><img src="<?php echo base_url(); ?>images/icon-gplus.png" alt=""/></a>
					<a href="#" class="social4b"><img src="<?php echo base_url(); ?>images/icon-youtube.png" alt=""/></a>
					<br/><br/><br/>
					<a href="#"><img src="<?php echo base_url(); ?>images/logosmal2.png" alt="" /></a><br/>
	...
	<div class="footerbg3black">
		...
		<a href="#">Blog</a> | 
		<a href="#">Contact</a>
		<a href="#top" class="gotop scroll"><img src="<?php echo base_url(); ?>images/spacer.png" alt=""/></a>
		</div>
	</div>
    ...
    <!-- Counter -->	
    <script src="<?php echo base_url(); ?>assets/js/js-list3.js"></script>	
