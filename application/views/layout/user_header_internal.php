		...
		<div class="container2 offset-0">
			...
			<div class="col-md-12  offset-0">
				...
				<div class="dashboard-left offset-0 textcenter">
					...
					<br/>
					<a href="<?php echo base_url(); ?>guardian/dashboard"><img src="<?php echo base_url(); ?>images/dash/logo.png" alt="" style="width:70%;max-width:277px"/></a><br/>
